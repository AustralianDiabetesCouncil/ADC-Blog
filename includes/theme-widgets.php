...
function adc_register_sidebars() {
	register_sidebar(
		array(
			'id' => 'widget-header',
			'name' => __( 'Header Widget', 'adc_basic' ),
			'description' => __( 'The following widgets will appear in the header.', 'adc_basic' ),
...
add_action( 'widgets_init', 'adc_register_sidebars' );